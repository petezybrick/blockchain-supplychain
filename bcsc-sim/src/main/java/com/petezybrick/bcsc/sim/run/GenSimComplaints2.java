...
public class GenSimComplaints2 {
	private static final Logger logger = LogManager.getLogger(GenSimComplaints2.class);
	...
	public static void main(String[] args) {
		try {
			...
			GenSimComplaints2 genSimComplaints = new GenSimComplaints2();
